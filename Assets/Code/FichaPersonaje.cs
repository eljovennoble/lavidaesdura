...
[CreateAssetMenu(fileName = "FichaPersonaje", menuName = "Nueva Ficha de Personaje")]
public class FichaPersonaje : ScriptableObject
{
...
//////////////////////////////////////
    public int Energia_Personaje;
    public int Felicidad_Personaje;
    public int Conocimiento_Personaje;
    public int Dinero_Personaje;
    public int Comida_Personaje;

////////////////////////////////////
    public int Experiencia_Personaje;
    public int Nivel_Personaje;
    public int LevelUpState;
    public int Criterio_Profesor;
    public int Favor_Jefe;
    public float Promedio_Personaje;
    public int Estado_Personaje;
////////////////////////////////////
   ///Cualidades
...
////////////////////////////////////
  ...
  public FichaPersonaje(string nombre_personaje, int energia_Personaje, int felicidad_Personaje, int conocimiento_Personaje, int dinero_Personaje, int comida_Personaje, int experiencia_Personaje, int nivel_Personaje, int levelUpState, int suerte_Personaje, int inteligencia_Personaje, int carisma_Personaje)
    {
    ...
    public void setFelicidad(int aa) { 
        ...
        if (Felicidad_Personaje > 100) { Felicidad_Personaje = 100; }
    }
    ...
    public void setComida(int ha) {
        ...
        if (Comida_Personaje > 100) { Comida_Personaje = 100; }
    }
